...
<body>
   ...
   <div class="container">
      ...
      <!-- Botão de atalho para a tela de criação de novos fornecedores -->
      <a class="novo" href="index.php?acao=fornecedor_novo">+ Novo fornecedor</a>
      ...
      <!-- Sintaxe alternativa do foreach: percorre o array $fornecedores -->
      ...
      <tr>
         ...
         <a class="btn editar"
            href="index.php?acao=fornecedor_editar&id=<?= $linha['id'] ?>">
            Editar
         </a>

         <!-- Link de exclusão com alerta nativo em JavaScript para prevenir cliques acidentais -->
         <a class="btn excluir"
            href="index.php?acao=fornecedor_deletar&id=<?= $linha['id'] ?>"
